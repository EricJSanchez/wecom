...
func NewSDKErr(code int64, msgList ...string) Error {
	...
	case 84074:
		return SDKNotExternalContactAuth
	case 41041:
		return SDKUserLimit
	case 41054:
		return SDKACCOUNTNotUseful
	case 60111:
		return SDKUseridNotFound
	case 40098:
		return SDKUserNotCheck
	case 41045:
		return SDKApiContactMoreThanLimit
	case 60123:
		return SDKInvalidPartyId
